...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-category-dropdown', __webpack_require__(3));
    Vue.component('detail-category-dropdown', __webpack_require__(6));
    Vue.component('form-category-dropdown', __webpack_require__(9));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
         ...
         * 
         */
        createChildren: function createChildren($value) {}
    }
});
      ...
      _c("template", { slot: "field" }, [
        _c(
          "select",
          {
            ...
            attrs: { id: _vm.field.name, type: "select" },
            on: {
          ...
          [
            ...
            _vm._v(" "),
            _vm._l(_vm.field.categories, function(category, key) {
